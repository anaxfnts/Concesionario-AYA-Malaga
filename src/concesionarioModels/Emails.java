...
public class Emails {
	...
	public Emails() {
		...
		props.put("from", "concesionarioaya2@gmail.com");
		props.put("username", "concesionarioaya2@gmail.com");
		props.put("password", "ulxvzyjfptgvqgim");
	}
	
	//Método para enviar correos electronicos
