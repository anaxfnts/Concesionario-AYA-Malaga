...
public class GridpanelReparacionesDisponibles {
	...
	public List<AnchorPane> crearPaneles(List<Reparacion> reparacionList) throws IOException {
		...
		for (int i = 0; i < reparacionList.size(); i++) {
			FXMLLoader loader = new FXMLLoader(getClass().getResource("/concesionarioViews/ReparacionDisponible.fxml"));
			AnchorPane root = loader.load();
			ReparacionesDisponiblesController controlador = loader.getController();
