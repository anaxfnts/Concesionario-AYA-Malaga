...
public class VerReparacionesDisponiblesController implements Initializable {

	Session sesion = HibernateUtil.getSession();
	ReparacionDisponibleDAO gestorReparaciones = new ReparacionDisponibleDAO(sesion);
	
	
	//Gridpanel
	private GridpanelReparacionesDisponibles grid = new GridpanelReparacionesDisponibles();
	...
	//Todos los elementos
	@FXML
	private BorderPane borderPaneReparacionesDisponibles;
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		try {
			listaReparaciones = gestorReparaciones.estadoDisponibleYAsignada(LoginController.comprobar.getNombre());
			paneles = grid.crearPaneles(listaReparaciones);
			nuevoGrid = grid.crearGridPane(columna, fila, paneles);
			borderPaneReparacionesDisponibles.setCenter(nuevoGrid);
