...
import utils.GridpanelReparacionesDisponibles;
import utils.GridpanelReparacionesFinalizadas;

public class VerReparacionesFinalizadasController implements Initializable{

	Session sesion = HibernateUtil.getSession();
	ReparacionFinalizadaDAO gestorReparaciones = new ReparacionFinalizadaDAO(sesion);
	
	
	
	private GridpanelReparacionesFinalizadas grid = new GridpanelReparacionesFinalizadas();
	...
	@FXML
	private BorderPane borderPaneReparacionesFinalizadas;
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		try {
			listaReparaciones = gestorReparaciones.estadoFinalizadasYAsignada(LoginController.comprobar.getNombre());
			paneles = grid.crearPaneles(listaReparaciones);
			nuevoGrid = grid.crearGridPane(columna, fila, paneles);
			borderPaneReparacionesFinalizadas.setCenter(nuevoGrid);
